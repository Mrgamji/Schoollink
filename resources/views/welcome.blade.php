...
<html lang="en">
    ...
    <!--end::Aside search-->
					...
					<div class="aside-menu flex-column-fluid">
						...
						<a href="/logout"><span class="menu-link">
										<span class="menu-icon">
						...
						@endphp
								...
								<div class="menu-item pt-5">
									...
									<div class="menu-content">
										<span class="menu-heading fw-bold text-uppercase fs-7">School Categories</span>
									</div>
									<!--end:Menu content-->
								</div>
								<!--end:Menu item-->
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div class="menu-item">
											...
											<a class="menu-link" href="dist/pages/user-profile/overview.html">
												...
												<span class="menu-title">Boarding Schools</span>
											</a>
											<!--end:Menu link-->
										</div>
										<!--end:Menu item-->
                                        ...
                                        <div class="menu-item">
											...
											<a class="menu-link" href="dist/pages/user-profile/overview.html">
												...
												<span class="menu-title">Day Schools</span>
											</a>
											<!--end:Menu link-->
										</div>
										...
										<div class="menu-item">
											...
											<a class="menu-link" href="dist/pages/user-profile/projects.html">
												...
												<span class="menu-title">Islamiyya Schools</span>
											</a>
											<!--end:Menu link-->
										</div>
										<!--end:Menu item-->
										...
										<div class="menu-item">
											...
											<a class="menu-link" href="dist/pages/user-profile/campaigns.html">
												...
												<span class="menu-title">Tsangaya Schools</span>
											</a>
											<!--end:Menu link-->
										</div>
										<!--end:Menu item-->
										...
										<div class="menu-item">
											...
											<a class="menu-link" href="dist/pages/user-profile/documents.html">
												...
												<span class="menu-title">Boys Only Schools</span>
											</a>
											<!--end:Menu link-->
										</div>
										<!--end:Menu item-->
										...
										<div class="menu-item">
											...
											<a class="menu-link" href="dist/pages/user-profile/followers.html">
												...
												<span class="menu-title">Girls Only Schools</span>
											</a>
											<!--end:Menu link-->
										</div>
										<!--end:Menu item-->
										...
										<div class="menu-item">
											...
											<a class="menu-link" href="dist/pages/user-profile/activity.html">
												...
												<span class="menu-title">Private Schools</span>
											</a>
											<!--end:Menu link-->
										</div>
										<!--end:Menu item-->
                                        <div class="menu-item">
											...
											<a class="menu-link" href="dist/pages/user-profile/overview.html">
												...
												<span class="menu-title">Public Schools</span>
											</a>
											<!--end:Menu link-->
										</div>
									</div>
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div class="menu-item">
											...
											<a class="menu-link" href="dist/account/security.html">
												...
												<span class="menu-title">Urban</span>
											</a>
											<!--end:Menu link-->
										</div>
										<!--end:Menu item-->
										...
										<div class="menu-item">
											...
											<a class="menu-link" href="dist/account/activity.html">
												...
												<span class="menu-title">Rural</span>
											</a>
											<!--end:Menu link-->
										</div>
										<!--end:Menu item-->
								...
								<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
									...
									<span class="menu-link">
										...
										<span class="menu-title">Timing</span>
										<span class="menu-arrow"></span>
									</span>
									<!--end:Menu link-->
									<!--begin:Menu sub-->
									<div class="menu-sub menu-sub-accordion">
										...
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
											...
											<span class="menu-link">
												...
												<span class="menu-title">Morning Schools</span>
												<span class="menu-arrow"></span>
											</span>
                                            <span class="menu-link">
												<span class="menu-bullet">
												...
												<span class="menu-title">Afternoon Schools</span>
												<span class="menu-arrow"></span>
											</span>
                                            <span class="menu-link">
												<span class="menu-bullet">
												...
												<span class="menu-title">Evening Schools</span>
												<span class="menu-arrow"></span>
											</span>
											<!--end:Menu link-->
											</div>
								...
								<div class="d-flex flex-column flex-xl-row">
									...
									<div class="d-flex flex-row-fluid me-xl-9 mb-10 mb-xl-0">
										...
										<div class="card card-flush card-p-0 bg-transparent border-0">
											...
											<div class="card-body">
												<!--begin::Nav-->
            <ul class="nav nav-pills d-flex flex-wrap justify-content-start nav-pills-custom gap-2 mb-4">
				<!--begin::Post-->
								...
								<form action="/search" method=get>
									...
									<div class="card mb-7">
										...
										<div class="card-body">
											...
											<!--end::Compact form-->
											<!--begin::Advance form-->
											<div class="collapse p-6" id="kt_advanced_search_form">
												<!--begin::Separator-->
													...
													<div class="col-xxl-7">
														...
														<div class="row g-8">
															...
															<div class="col-lg-4">
																...
																<input type="text" class="form-control form-control form-control-solid" name="state" />
															</div>
															<div class="col-lg-4">
																<label class="fs-6 form-label fw-bold text-dark">Local Government</label>
																<input type="lga" class="form-control form-control form-control-solid" name="city" />
															</div>
															<div class="col-lg-4">
																<label class="fs-6 form-label fw-bold text-dark">Address</label>
																<input type="address" class="form-control form-control form-control-solid" name="city" />
															</div>
															<!--end::Col-->
														</div>
														<!--end::Row-->
														...
														<div class="row g-8">
															...
															<div class="col-lg-6">
																...
																<select class="form-select form-select-solid" data-control="select2" data-placeholder="In Progress" data-hide-search="true">
																	...
																	<option value="boarding" selected="selected">Boarding Schools</option>
																	<option value="islamiyya" selected="selected">Islamiyya Schools</option>
																	<option value="tsangaya" selected="selected">Tsangaya Schools</option>
																	<option value="public" selected="selected">Public Schools</option>
																	<option value="private" selected="selected">Private Schools</option>
																</select>
																<!--end::Select-->
															</div>
															<!--end::Col-->
	...
	<div class="d-flex justify-content-center">
		<div class="card bg-light-success p-5 mb-5">
			<div class="card-header">
				<h3 class="card-title fw-bold text-gray-800">School Categories</h3>
			</div>
			<div class="card-body">
				<ul class="nav nav-pills d-flex flex-wrap justify-content-start nav-pills-custom gap-2 mb-4" style="flex-wrap: nowrap; overflow-x: auto;">
					@foreach($categories as $index => $category)
					<a href='/filter/{{$category->name}}'>
						<li class="nav-item bg-white me-2 py-2" style="flex: 0 0 auto; min-width: 100px;">
						<center><i class="ki-duotone ki-row-horizontal fs-2">
							<span class="path1"></span>
							<span class="path2"></span>
						</i></center>
						<div class="text-center">
							<span class="text-gray-800 fw-bold fs-5 d-block">{{ucfirst($category->name)}}</span>
							<span class="text-gray-400 fw-semibold fs-8">8 Schools</span>
						</div>
					</li></a>
					@endforeach
				</ul>
								...
								<div class="timeline-content mb-10 mt-n1">
									...
									<div class="overflow-auto pb-5">
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
											...
											<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
												<!--begin::Icon-->
												<img alt="dist/apps/projects/project.html" class="w-30px me-3" src="dist/assets/media/svg/files/doc.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
											...
											<div class="d-flex flex-aligns-center">
												<!--begin::Icon-->
												<img alt="dist/apps/projects/project.html" class="w-30px me-3" src="dist/assets/media/svg/files/css.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
				...
				<div class="card-body hover-scroll-overlay-y h-400px pt-5">
					...
					<div class="d-flex flex-stack">
						...
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="dist/assets/media/stock/600x400/img-1.jpg" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
					...
					<div class="d-flex flex-stack">
						...
						<!--begin::Pic-->
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="dist/assets/media/stock/600x400/img-3.jpg" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
					...
					<div class="d-flex flex-stack">
						...
						<!--begin::Pic-->
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="dist/assets/media/stock/600x400/img-8.jpg" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
					...
					<div class="d-flex flex-stack">
						...
						<!--begin::Pic-->
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="dist/assets/media/stock/600x400/img-26.jpg" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
					...
					<div class="d-flex flex-stack">
						...
						<!--begin::Pic-->
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="dist/assets/media/stock/600x400/img-21.jpg" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
					...
					<div class="d-flex flex-stack">
						...
						<!--begin::Pic-->
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="dist/assets/media/stock/600x400/img-34.jpg" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
					...
					<div class="d-flex flex-stack">
						...
						<!--begin::Pic-->
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="dist/assets/media/stock/600x400/img-27.jpg" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
